...
<section class="content">
	...
	<div class="tit-con clear">
		...
		<div class="f-r ma-t-5">
			<a href="/">Home</a> > <a href="/Journal">Journal List</a> > Journal Detail
		</div>
	</div>
	...
	<div class="con-tbl ma-t-15">
		...
		<div id="jnldetaildiv">
			<div class="con-search clear">
				<select id="yearSelect" name="field" style="display: none;"
					onchange="updateJournalData()">
			...
			<div class="tbl-scr">
				<table class="ma-t-10">
					<thead>
						<tr>
							<th colspan="3">JSR</th>
							<th rowspan="2">Journal<br />Impact Index
							</th>
